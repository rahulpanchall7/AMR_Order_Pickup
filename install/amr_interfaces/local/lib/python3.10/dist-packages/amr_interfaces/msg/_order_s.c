...
bool amr_interfaces__msg__order__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("amr_interfaces.msg._order.Order", full_classname_dest, 31) == 0);
  }
  amr_interfaces__msg__Order * ros_message = _ros_message;
  {  // order_id
...
PyObject * amr_interfaces__msg__order__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("amr_interfaces.msg._order");
