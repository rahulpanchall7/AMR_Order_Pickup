...
#include "interfaces/msg/detail/order__rosidl_typesupport_fastrtps_c.h"
...
using _Order__ros_msg_type = interfaces__msg__Order;
...
size_t get_serialized_size_interfaces__msg__Order(
  const void * untyped_ros_message,
...
static uint32_t _Order__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__Order(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__msg__Order(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces__msg__Order;
    is_plain =
      (
...
static size_t _Order__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__msg__Order(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, msg, Order)() {
