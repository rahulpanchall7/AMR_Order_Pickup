...
#include "interfaces/msg/detail/order__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::Order & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::Order & ros_message)
{
  // Member: order_id
  cdr >> ros_message.order_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::Order;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::Order *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::Order *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_Order__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, Order)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_Order__handle;
}
