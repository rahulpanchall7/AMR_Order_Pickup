...
{
  new (message_memory) amr_interfaces::msg::Order(_init);
}

void Order_fini_function(void * message_memory)
{
  auto typed_message = static_cast<amr_interfaces::msg::Order *>(message_memory);
  typed_message->~Order();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Order_message_member_array[2] = {
  {
    ...
    offsetof(amr_interfaces::msg::Order, order_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(amr_interfaces::msg::Order, description),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Order_message_members = {
  ...
  "Order",  // message name
  2,  // number of fields
  sizeof(amr_interfaces::msg::Order),
...
get_message_type_support_handle<amr_interfaces::msg::Order>()
{
  return &::amr_interfaces::msg::rosidl_typesupport_introspection_cpp::Order_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, amr_interfaces, msg, Order)() {
  return &::amr_interfaces::msg::rosidl_typesupport_introspection_cpp::Order_message_type_support_handle;
}
