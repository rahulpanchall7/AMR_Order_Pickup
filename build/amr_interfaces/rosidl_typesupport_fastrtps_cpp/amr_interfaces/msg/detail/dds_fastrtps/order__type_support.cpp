...
#include "amr_interfaces/msg/detail/order__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = amr_interfaces::msg::Order;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const amr_interfaces::msg::Order *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<amr_interfaces::msg::Order *>(
    untyped_ros_message);
...
{
  return &amr_interfaces::msg::typesupport_fastrtps_cpp::_Order__handle;
}
